...
<aside class="w-56 bg-white h-screen fixed top-0 left-0 bottom-0 overflow-hidden border-r shadow-md">
  ...
  <main class="ml-56 p-8">
    <h2 class="text-2xl font-semibold mb-4 text-secondary titulo">Lista de Co-formadoras</h2>
    <a href="addStaff.php">
        <button class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700 buttonAddStaff">Crear una Co-Formadora</button>
    </a>
    ...
    <tr>
      ...
      //  require "./../../vendor/autoload.php";
        ...
        $result = $staffList ->getCoformadora();
